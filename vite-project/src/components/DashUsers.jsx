  ...
  return (
    <div className="overflow-x-auto p-3 md:mx-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 dark:scrollbar-thumb-gray-600 dark:scrollbar-track-gray-800">
      {currentUser?.isAdmin && users.length > 0 ? (
        ...
        <p className="text-center text-gray-500 dark:text-gray-400">You have no users yet!</p>
      )}
      {showMore && (
        <button
      ...
      >
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden max-w-lg w-full transform transition-all duration-300 ease-in-out">
          <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
            <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100">User Deletion</h3>
            <button
